                                    ...
                                    @else
                                        @foreach ($offers as $index=>$offer)
                                            <tr>
                                                <td>{{$index+1}}</td>
                                                <td>
                                                    <a href="{{asset('uploads/offers/'.$offer->image)}}" target="_blank"><img src="{{asset('uploads/offers/'.$offer->image)}}" width="100px" /></a>
                                                </td>
                                                <td>{{$offer->name}}</td>
                                                {{-- <td>{{$offer->price}}</td> --}}
                                                <td>
    ...
    <div class="modal fade" id="addOfferModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="addForm" enctype="multipart/form-data" action="{{url('Dashboard/offers')}}" method="post">
                    @csrf
                    @method('POST')
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <img src="{{asset('uploads/offers/default.jpg')}}" width="100px" class="img-thumbnail image-preview">
                        </div>
                        <div class="form-group">
